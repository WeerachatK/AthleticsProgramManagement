    ...
    <div className=" overflow-hidden min-w-[100%] H-news relative">
      ...
      >
        {newsData.map((article, idx) => (
          <div className="inline-block H-news w-full" key={idx}>
            <div className=" relative">
              ...
              leading-normal  bottom-[240px] left-[77px]  truncate "
                ...
                <a tget="_blank" href={article.url}>
                  <button
              ...
              rounded-lg border border-white absolute bottom-[0px] left-[192px]"
                ...
                <img
                  className="inline-block h-screen-nav w-full object-cover overflow-hidden Shadow"
